...
public class KthSmallestProduct {
    ...
    // countLE(x, nums1, nums2) counts how many pairs (i, j) satisfy nums1[i] *
    // nums2[j] <= x.
    static long countLE(long x, int[] nums1, int[] nums2) {
        ...
        for (int a : nums1) {
            if (a > 0) {
                ...
                // We want b such that: a * b <= x. Because a is negative, divide by a (and
                // reverse inequality):
                // This becomes: b >= ceil(x / a). We can count how many b's in nums2 (which is
    ...
    public static void main(String[] args) {
        ...
        int[] nums2b = { 2, 4 };
        int k2 = 6;
        // The 6 smallest products (in sorted order): -16, -8, -8, -4, 0, 0, 6, 12. The
        // 6th smallest is 0.
